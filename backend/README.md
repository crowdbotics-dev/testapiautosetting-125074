...
## Project Structure
    ...
    ├── testapiautosetting_125074  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125074`
...
2. Clone this repo and `cd testapiautosetting_125074`
